    ...
    render() {
        return (
            ...
            <div className="manageAccount">
                ...
                <p>
                    Enter information in the fields you would like to update and click Submit.
                </p>
                <div class="google">
                    <a href="#"><img src="../images/btn_google_signin_dark_normal_web.png" alt="google manage account"/></a>
                </div>
                <div>
